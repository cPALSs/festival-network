...
| **AI agents** | **Clone the [repo](https://github.com/cPALSs/festival-network)** and start at [AGENTS.md](https://github.com/cPALSs/festival-network/blob/main/AGENTS.md). Structured markdown, JSON, and the sheet registry live in the tree — agents work from the clone, not from scraped HTML. |
...
See [Using market research](research.html) for how to read and contribute. **AI agents:** clone the repo and start at [AGENTS.md](https://github.com/cPALSs/festival-network/blob/main/AGENTS.md) — schemas, JSON graphs, and file paths are there, not on these pages.
